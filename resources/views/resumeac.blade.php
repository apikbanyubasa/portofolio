                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">2nd Place - Lomba Poster Umum Tingkat
                                Nasional
                            </h3>
                            <p class="text-sm text-gray-600 italic">Juni 2024</p>
                            <p class="text-sm text-gray-600">Lomba Seni dan Sastra Nasional
