...
<body class="bg-gradient-to-br from-purple-100 via-blue-100 to-white text-gray-800 font-[Poppins] overflow-x-hidden">
    <div class="min-h-screen flex flex-col">
        ...
        <header id="navbar" class="navbar-blur fixed top-0 w-full z-50 border-none">
            <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <nav class="hidden md:flex md:items-center space-x-6 text-xl font-extrabold">
                    ...
                    <a href="{{ url('/resumeed') }}"
                        class="transition transform hover:scale-105 hover:text-blue-600 {{ Request::is('resumeac') ? 'text-blue-600' : 'text-gray-700' }}">
                        Resume
                    </a>
                    <a href="{{ url('/projects') }}"
            ...
            <div id="mobile-menu"
                ...
                <a href="{{ url('/resumeed') }}"
                    class="block py-2 transition transform hover:scale-105 hover:text-blue-600 {{ Request::is('resumeac') ? 'text-blue-600' : 'text-gray-700' }}">
                    Resume
                </a>
                <a href="{{ url('/projects') }}"
        ...
        <main class="flex-grow">
            ...
            <section id="achievement" class="text-gray-800 mb-8 px-6">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl p-3 sm:p-6 shadow-md">
                            <h3 class="text-base lg:text-xl font-semibold text-purple-700">2nd Place - Lomba Poster Umum
                                Tingkat
                                Nasional
                            </h3>
                            <p class="text-xs lg:text-sm text-gray-600 italic">Lomba Seni dan Sastra Nasional
                                yang Diselenggarakan oleh Penerbit Redgolden Media
                                Indonesia dengan tema BEBAS
                            </p>
                            <p class="text-xs lg:text-sm text-gray-600">Juni 2024</p>
                        </div>
                    </div>
                </div>
            </section>
