                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">IPB University</h3>
                            <p class="text-sm text-gray-600 italic">Bachelor of Applied Science in Software Engineering
                            </p>
                        ...
                        <!-- Example: SMA -->
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">SMAN 1 Babakan</h3>
                            <p class="text-sm text-gray-600 italic">Ilmu Pengetahuan Alam</p>
                            <p class="text-sm text-gray-600">2019 - 2022</p>
                        </div>
                    </div>
                </div>
            </section>
