...
<body class="bg-gradient-to-br from-purple-100 via-blue-100 to-white text-gray-800 font-[Poppins] overflow-x-hidden">
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow">
            ...
            <section id="education" class="text-gray-800 mb-8 px-6">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl p-3 sm:p-6 shadow-md">
                            <h3 class="text-base lg:text-xl font-semibold text-purple-700">IPB University</h3>
                            <p class="text-xs lg:text-sm text-gray-600 italic">Bachelor of Applied Science in Software
                                Engineering
                            </p>
                            <p class="text-xs lg:text-sm text-gray-600">2022 - Present</p>
                        </div>

                        <!-- Add more entries if needed -->
                        <!-- Example: SMA -->
                        <div class="bg-white rounded-xl p-3 sm:p-6 shadow-md">
                            <h3 class="text-base lg:text-xl font-semibold text-purple-700">SMAN 1 Babakan</h3>
                            <p class="text-xs lg:text-sm text-gray-600 italic">Ilmu Pengetahuan Alam</p>
                            <p class="text-xs lg:text-sm text-gray-600">2019 - 2022</p>
                        </div>
                    </div>
                </div>
            </section>
