                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">"Blackbox Testing of the Garuda Farm
                                Website
                                Using
                                the Equivalence Partitioning Technique"</h3>
                            <p class="text-sm text-gray-600 italic">JURNAL KRIDATAMA SAINS DAN TEKNOLOGI, Desember 2024
                            </p>
                            <a href="https://jurnal.umnu.ac.id/index.php/kst/article/view/1420"
                                class="text-purple-500 hover:text-purple-700">Read Full Paper</a>
                        </div>
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">"THE INFLUENCE OF TIKTOK SHORT-FORM VIDEOS
                                ON
                                ATTENTION SPAN AND STUDY HABITS OF STUDENTS IN COLLEGE OF VOCATIONAL STUDIES IPB
                                UNIVERSITY"
                            </h3>
                            <p class="text-sm text-gray-600 italic">Edutech: Jurnal Teknologi Pendidikan, Juni 2024</p>
                            <a href="https://ejournal.upi.edu/index.php/edutech/article/view/69229"
                                class="text-purple-500 hover:text-purple-700">Read Full Paper</a>
                        </div>
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">"Analisis Business Model Canvas pada
                                Bisnis
                                Creative Package di Industri Kreatif Digital"</h3>
                            <p class="text-sm text-gray-600 italic">Populer: Jurnal Penelitian Mahasiswa, Desember 2024
                            </p>
                            <a href="https://journal.unimar-amni.ac.id/index.php/Populer/article/view/2767"
                                class="text-purple-500 hover:text-purple-700">Read Full Paper</a>
                        </div>
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-purple-700">"Penerapan Klasifikasi Gambar Buah dalam
                                Aplikasi
                                FruityLens Menggunakan Metode CNN"</h3>
                            <p class="text-sm text-gray-600 italic">Jurnal Sistem Informasi dan Ilmu Komputer, November
                                2024
                            </p>
